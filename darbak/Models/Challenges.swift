...
class ChallengesData {
    ...
    let challenges: [Challenge] = [
        Challenge(imageName: "StopSign", prompt: "4 علامات مرورية", emojis: ["🛑", "🚦", "⚠️", "🚸", "📍", "🛤️"], totalPhotos: 4, modelName: "YOLOv3", hasAI: true),
        Challenge(imageName: "Car", prompt: "4 سيارات", emojis: ["🚌", "🚍", "🚐", "🚎", "🚗", "🚕"], totalPhotos: 4, modelName: "YOLOv3", hasAI: true),
